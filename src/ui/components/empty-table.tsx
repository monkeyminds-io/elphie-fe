...
// React Components
// =============================================================================
export const EmptyTable = ({item}: {item: string}) => {
    return (
        <div className="max-w-sm w-full min-h-[400px] flex flex-col justify-center gap-y-4 mx-auto px-6 py-4">
            ...
            <Paragraph children={`You haven't created any ${item}s yet. Let's get started by clicking on the button below!!`}/>

            <div className="mt-5 grid sm:flex gap-2">
                <button type="button" className="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-50 disabled:pointer-events-none transition-colors duration-300 ease-in-out">

        ...
        <form id='form-subscribe' action={''}>
            <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-[16px] p-2">
                <div className="w-full">
                    ...
                    <input type="text" id="email" name="email" className="py-3 px-4 block w-full border-transparent rounded-[8px] text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Enter your email"/>
                </div>
